...
* Stateful LSTM에 관해서는 아래 Link의 Post를 참고해 주시기 바랍니다.
  - https://moonlight314.github.io/deeplearning/lstm/LSTM_Ex_00/
...
* 흠... 동일한 Input Data Shape을 가지고, 동일한 Network 구조를 가지고 있는데도, 오히려 LSTM Output Neuron의 수는 훨씬 더 적은데도 성능은 상당히 좋습니다.   
